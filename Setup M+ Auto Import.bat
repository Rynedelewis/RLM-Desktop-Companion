...
echo     python "%~dp0raidlootmatrix_mplus.py" --week both ^> "%~dp0raidlootmatrix_mplus_auto.log" 2^>^&1 >> "%SILENT_BAT%"
echo     python "%~dp0rlm_discord_sync.py" --non-interactive ^>^> "%~dp0raidlootmatrix_mplus_auto.log" 2^>^&1 >> "%SILENT_BAT%"
echo ) >> "%SILENT_BAT%"
...
echo     exe = "python """ ^& scriptDir ^& "\rlm_importer_ui.py"" --watch-wow" >> "%WATCHER_VBS%"
